...
**This is the simple service, deliberately:** a YAML lookup and one transactional
write. The investigation steps are config, so an SRE improves them with a ConfigMap
edit rather than a deploy, and the reasoner gets a concrete checklist to ground its
analysis in rather than being asked to invent one.
