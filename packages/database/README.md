...
- **models**: SQLAlchemy models for every table (alerts, incidents,
  investigation_plans, recommendations, feedback, outbox_events,
  processed_events, runbook_documents, audit_log)
...
polled and dispatched by the outbox worker. See docs/adr/0003-postgres-outbox.md.
